...
class DefaultUniversityRepositoryTest {
    ...
    @Test
    fun getUniversitiesFromNetworkShouldCallUpsertAll() = runTest {
        ...
        coEvery { networkDataSource.loadAllUniversities() } returns mockNetworkUniversities
        ...
        coVerifyOrder {
            networkDataSource.loadAllUniversities()
            localDataSource.deleteAll()
            localDataSource.upsertAll(mockNetworkUniversities.toLocalUniversityList())
        }
